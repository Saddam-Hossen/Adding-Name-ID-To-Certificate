...
public class BabyEnglishPDF {
    public static void main(String[] args) {
        ...
        try (FileInputStream fis = new FileInputStream(excelFilePath);
           ...
           // generate pdf single
            ...
            String outputPdf = "C:\\reactjs\\ics\\pdf\\Baby_SNVN.pdf";  // Final merged PDF
    ...
    private static void createPDF(List<String> names, int fileIndex) {
        String inputPdf = "C:\\reactjs\\ics\\reserve\\BABY BOX.pdf";
        ...
        try {
           ...
           if(i==0)
           {
               ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), 145, 627 , 0);

           }
           else if(i==1){
             //  ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), startX, startY - (i * spacing), 0);
               ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), 405, 626 , 0);

           }

           else if(i==2){
              // ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), startX, startY - (i * spacing), 0);
               ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), 145, 232 , 0);

           }
           else{
              // ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), startX, startY - (i * spacing), 0);
               ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase(names.get(i), font), 415, 235 , 0);
