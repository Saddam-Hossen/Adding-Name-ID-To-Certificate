...
public class DelegateCardBranchCEM {
    ...
    public static void main(String[] args) throws DocumentException, IOException {
       ...
       // String xlsxFile = "G:\\pdf\\Delegate Card Update.xlsx";// for two
        String xlsxFile = "G:\\pdf\\Delegate Card - Branch CEM.xlsx";// for three
               ...
               // Cell uniqueIdC= row.getCell(0);
                ...
                if (idCell != null && nameCell != null && additionalInfoCell != null && k < 1000000) {
                   ...
                   // String existingImagePath = "G:\\pdf/banglafont/Delegate2.jpg";// for two
                    String existingImagePath = "G:\\pdf/banglafont/Delegate Card for Branch CEM04.jpg";// for three
                   ...
                   inputImagePath = createImageFromBengaliText(additionalInfo, customFontPath, outputImg,"2");
                    resultPath = overlayImage(resultPath, inputImagePath, 390, 1140, outputImagePath);

                    inputImagePath = createImageFromBengaliText(getValidFileName(name), customFontPath, outputImg,"2");
                    resultPath = overlayImage(resultPath, inputImagePath, 390, 1240, outputImagePath);
...
public static void generateBranchPdf() throws DocumentException, IOException {
    ...
    combineFullPdfs(data, "G:\\pdf/sodossoFinalBranch/"+"Branch CEM.SNVN Ltd.pdf");
