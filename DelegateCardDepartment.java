...
public class DelegateCardDepartment {
    static int count=1;
    public static void main(String[] args) throws DocumentException, IOException {
       ...
       // String xlsxFile = "G:\\pdf\\Delegate Card Update.xlsx";// for two
        String xlsxFile = "G:\\pdf\\Delegate Card Departmental Member last.xlsx";// for three
        ...
        try (FileInputStream fis = new FileInputStream(new File(xlsxFile));
            ...
            for (Row row : sheet) {
                ...
                Cell additionalInfoCell = row.getCell(3);// age 3
               // Cell uniqueIdC= row.getCell(0);

                if (idCell != null && nameCell != null && additionalInfoCell != null && k < 1000) {
                    k++;
                   ...
                   // String existingImagePath = "G:\\pdf/banglafont/Delegate2.jpg";// for two
                    String existingImagePath = "G:\\pdf/banglafont/Delegate Card for Departmental Member03.jpg";// for three
...
public static void generateBranchPdf() throws DocumentException, IOException {
    ...
    combineFullPdfs(data, "G:\\pdf/sodossoFinalBranch/"+"Present Departmental Member.SNVN Ltd.pdf");
